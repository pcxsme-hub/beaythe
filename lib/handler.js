...
export async function handle(request, env) {
  ...
  try {
    ...
    if (path === '/products/dropea-catalog' && m === 'GET') return err('Importación Dropea no disponible en este backend.', 503);
    ...
    if ((path === '/products/import' || path === '/products/bulk-import') && m === 'POST') return err('Importación Dropea no disponible en este backend.', 503);
